...
if __name__ == "__main__":
    ...
    criterion = SetCriterion(num_classes=20, matcher=matcher, class_weight=class_weight, eos_coef=0.05, class_loss_fn="focal")
    
    train_loss, _ = train_loop(model, train_loader, optimizer, criterion, 5, 4)
